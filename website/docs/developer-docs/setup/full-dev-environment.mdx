...
:::info
The very first time a worker runs, it might need some time to clear the initial task queue.
:::
...
Once your code passes all checks, submit a pull request on [GitHub](https://github.com/goauthentik/authentik/pulls). Be sure to:
